...
export default function Page() {
  const SETTINGS_TABS = [
    ...
    // },
    {
      ...
      tooltip: 'Integrate and manage SMTP configurations to streamline connection.',
      pageTitle: 'Email Notifications',
      pageSubheading:
        'Manage the SMTP settings used for sending email notifications in the Pabbly Hook application. ',
    },
    {
      value: 'activity-log',
      ...
      label: 'Activity Log',
      tooltip:
        'Track and monitor all team members activities within the Pabbly Hook Admin Panel.',
      pageTitle: 'Activity Log',
      pageSubheading:
        'Track and monitor all team members activities within the Pabbly Hook Admin Panel, including actions such as updating events, blocking/unblocking connections, and configuring email notifications. ',
  ...
  return (
    <>
      ...
      <DashboardContent maxWidth="xl">
        <CustomTabs
          tabs={SETTINGS_TABS}
          defaultTab="email-notifications"
          defaultPath="/admin/settings/email-notifications"
