...
import { SharedWithTableRow } from './shared-with-table-row';
import { SharedWithTableToolbar } from './shared-with-table-toolbar';
import { SharedWithTableFiltersResult } from './shared-with-table-filters-result';
...
const TABLE_HEAD = [
  ...
  {
    id: 'business_shared_by',
    label: 'Business Shared By',
    width: '200px',
    whiteSpace: 'nowrap',
...
const dataOn = [
  ...
  {
    id: '2',
    shared_date: 'Oct 24, 2024 14:30:15',
    email: 'admin@company.com',
    business_shared: 'Tech Solutions Inc',
...
export function SharedWithTable() {
        ...
        title={
          <Box display="inline-block">
            <Tooltip arrow placement="top" disableInteractive title="Folder Name: Home">
              <Typography variant="h6">Folders Shared With You</Typography>
            </Tooltip>
          </Box>
        }
