        ...
        <Card>
          ...
          <Box sx={{ p: 3 }}>
            <FormControl fullWidth sx={{ mb: 2 }}>
              ...
              >
                <Box
                  sx={{ p: 2, position: 'sticky', top: -4, zIndex: 1, bgcolor: 'background.paper' }}
                >
                  <TextField
                    fullWidth
                    size="medium"
                    ...
                    InputProps={{
                      startAdornment: (
                        <InputAdornment position="start">
                          <Iconify icon="mdi:search" width={24} height={24} />
                        </InputAdornment>
                      ),
                    }}
                  />
              ...
              <FormHelperText>
                View connections, requests, events and transformations execution times based on
                selected time zone.{' '}
                <a
